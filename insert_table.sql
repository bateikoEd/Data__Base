...
INSERT INTO employees (full_name,rang_id,department_id,team_id,count_of_children,sex,salary,overview,age,experiance)
	VALUES ('Буркацький Микита Романович', 1, 1, 0, 2, 'Чоловік',20000,TRUE,35,10),
			("Д'яченко Анна Сергіївна", 2, 1, 1, 2, 'Жінка',2000,TRUE,40,5),
            ('Деменкова Валерія Віталіївна', 3, 1,1, 10, 'Не визначився',13000,TRUE,25,4),
            ('Затірка Валерія Валеріївна', 4, 1,2, 4, 'Жінка',2000,TRUE,35,15),
            ('Морозов Роман Дмитрович', 5, 1,2, 5, 'Чоловік',2000,TRUE,20,1),
            
            ('Наконечна Влада Андріївна', 1, 2,0, 2, 'Жінка',30000,TRUE,30,12),
            ('Науменко Віталій Євгенійович ', 2, 2,1, 3, 'Жінка',2000,FALSE,25,5),
            ('Нерубенко Анастасія Андріївна', 3, 2,1, 0, 'Жінка',2000,TRUE,20,1),
            ("П'ятецька Анна Андріївна", 4, 2,2, 0, 'Жінка',2000,FALSE,30,5),
            ('Пастушок Олена Олегівна', 5, 2,3, 2, 'Жінка',20000,TRUE,30,6),
            ('Пересунько Марина Олександрівна', 1, 3,0, 4, 'Чоловік',200000,TRUE,50,25);
...
INSERT INTO tickets (journey_id,full_name,ticket_status,buying_time,return_time,price,
	...
	VALUES (1,'Харченко Роман Андрійович', 'заброньовано',NULL,NULL,500,1,1,'Не визначився',50,1),
			(1,'Худіков Павел Володимирович ', 'куплено','2020-03-10 12:45:30',NULL,500,1,2,'Чоловік',45,1),
            (1,'Шахворостова Влада Дмитрівна', 'повернено','2020-03-10 12:45:30','2020-03-10 12:55:30',500,1,3,'Не визначився',35,1),
			(1,'Щедров Максим Олександрович', 'куплено','2020-03-12 12:45:30',NULL,500,1,4,'Чоловік',78,0),
            (1,'Яцько Яна Віталіївна', 'заброньовано',NULL,NULL,500,1,5,'Жінка',16,0),
			(1,'Буханевич Родіон Михайлович', 'куплено','2020-03-14 12:45:30',NULL,500,1,6,'Чоловік',30,0),
            (6,'Шепель Ірина Олександрівна', 'повернено','2020-03-01 12:45:30','2020-03-10 15:45:30',500,1,1,'Не визначився',50,1),
			(1,'Кулина Анісія Петрівна', 'куплено','2020-03-10 12:45:30',NULL,500,1,7,'Чоловік',45,1),
            (6,'Котів Сергій Володимирович', 'куплено','2020-03-09 12:02:30',NULL,500,1,7,'Чоловік',25,1);
